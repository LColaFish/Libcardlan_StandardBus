...
- 返回值:操作结果：0成功，其他失败 
**************************************************************************************************************/
JNIEXPORT jint JNICALL JNI_API_DEF(PsamCmd)(JNIEnv *env, jobject obj,jchar PsamIndex,jbyteArray sendcmd,jint sendlen,jbyteArray rcvcmd,jbyteArray rcvlen)                                                                
{
    (void)env;                                                                                                                               
    (void)obj;
...

    {
        ...
        (*env)->SetByteArrayRegion(env, rcvcmd, 0, rcvlen[0], (jbyte *)rcvbuf);
    }
